...
! Minors (6) : Ride on background of mean winds derived from majors
  integer, parameter :: iNO_     =  9
  integer, parameter :: iH_ =  10
  integer, parameter :: iN2D_ =  11
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !BP: B&K 1973 (part B), Chapter 15
  !BP: Adding NO diffusion coefficients now that nSpecies = iNO_ = 9
 real, parameter, dimension(nSpecies, nSpecies) :: Diff0 = 1.0e17 * reshape( (/ &
     !----------------------------------------------------------------------+
     ! i=C02      CO      O        N2      O2      Ar    He       N4S    NO
     !----------------------------------------------------------------------+
       0.0000, 0.7762, 0.2219,  0.6580,  0.5770, 1.1920, 2.4292, 0.2219, &!0.7762, &  ! CO2
       0.7762, 0.0000, 0.9466,  0.9280,  0.8300, 0.6625,1159.55, 0.9466, &!0.0000, &  ! CO
       0.2219, 0.9466, 0.0000,  0.9690,  0.9690, 0.5510, 3.4346, 0.9690, &!0.9466, &  ! O
       0.6580, 0.9280, 0.9690,  0.0000,  0.7150, 0.6640, 2.9400, 0.9690, &!0.9280, &  ! N2
       0.5770, 0.8300, 0.9690,  0.7150,  0.0000, 0.7170, 3.2070, 0.9690, &!0.8300, &  ! O2
       1.1920, 0.6625, 0.5510,  0.6640,  0.7170, 0.0000,1000.00, 0.5510, &!0.6625, &  ! Ar
       2.4292,1159.55, 3.4346,  2.9400,  3.2070,1000.00, 0.0000, 3.34346, &!1159.55, &  ! He
       0.2219, 0.9466, 0.9690,  0.9690,  0.9690, 0.5510, 3.4346, 0.0000 /), &!0.9466, & ! N4S 
       !0.7762, 0.0000, 0.9466,  0.9280,  0.8300, 0.6625, 1159.55, 0.9466, 0.0000 /), &  ! NO
       (/nSpecies,nSpecies/) )
  ...
  ! These are s-exponents from B&K (1973) formulation: T**s
   real, parameter, dimension(nSpecies, nSpecies) :: DiffExp = reshape( (/ &
     ...
     ! i=C02      CO      O     N2     O2     Ar     He   N4S    NO
     !----------------------------------------------------------+
       0.000,  0.750,  0.750, 0.758, 0.749, 0.750, 0.720, 0.750, &!0.750, &  ! CO2
       0.750,  0.000,  0.750, 0.710, 0.724, 0.750, 0.524, 0.750, &!0.000, & ! CO
       0.750,  0.750,  0.000, 0.774, 0.774, 0.841, 0.749, 0.750, &!0.750, &  ! O
       0.758,  0.710,  0.774, 0.000, 0.750, 0.752, 0.718, 0.774, &!0.710, &  ! N2
       0.749,  0.724,  0.774, 0.750, 0.000, 0.736, 0.710, 0.774, &!0.724, &  ! O2
       0.750,  0.750,  0.841, 0.752, 0.736, 0.000, 0.524, 0.841, &!0.759, &  ! Ar
       0.720,  0.524,  0.749, 0.718, 0.710, 0.524, 0.000, 0.749, &!0.524, &  ! He
       0.750,  0.750,  0.750, 0.774, 0.774, 0.841, 0.749, 0.000 /), &!0.750, & !N4S
       !0.750,  0.000,  0.750, 0.710, 0.724, 0.750, 0.524, 0.750, 0.000/), & ! NO
       (/nSpecies,nSpecies/) )
