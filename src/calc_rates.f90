...
!    endif
     ...
     !BP (8/31/2020) Add Thermal conduction for CO2, O, and N2 using            
     !Schunk and Nagy parameterization
     KappaTemp(:,:,iAlt,iBlock) = NDensityS(1:nLons,1:nLats,iAlt,iCO2_,iBlock) / &
             NDensity(1:nLons,1:nLats,iAlt,iBlock) * ThermalConduction_ACO2 * &
             (Temperature(1:nLons,1:nLats,iAlt,iBlock)* &
             TempUnit(1:nLons,1:nLats,iAlt))**ThermalConduction_sCO2 + &
             NDensityS(1:nLons,1:nLats,iAlt,iO_,iBlock) / &
             ...
             NDensity(1:nLons,1:nLats,iAlt,iBlock)* ThermalConduction_AN2 * &
             (Temperature(1:nLons,1:nLats,iAlt,iBlock)* &
             TempUnit(1:nLons,1:nLats,iAlt))**ThermalConduction_s
